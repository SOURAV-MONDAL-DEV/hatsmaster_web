...
export default function WhyChooseUs() {
    return (
        <section className="relative w-full h-full ">
          <img src={ManyHats.src} alt="textile rolls background" className="absolute inset-0 w-full h-full object-cover" />
          ...
          <div className="relative z-10 lg:flex items-center justify-between h-full p-6 lg:px-48 lg:py-24 ">
            ...
            <div className=" flex gap-2 relative  ">
              ...
              <p className="text-lg">We specialize in sourcing and selling a wide variety of textile products, ensuring a transparent approach, quality materials and speed of shipment.</p>
            </div>
